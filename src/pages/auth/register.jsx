    ...
    <>
      ...
      <motion.section className="register overflow-hidden min-h-screen flex items-end md:items-center justify-center">
        ...
        <div className="block lg:hidden md:block">
          ...
          <p className="text-sm font-normal text-white my-1 jost">
          ...
          <form onSubmit={handleFormSubmit}>
                  ...
                  <Input
                    ...
                    className={` ${
                      touched.username && errors.username
                        ? "border-red-500"
                        : touched.username && "border-green-500"
                    } border-black`}
                  ...
                  <Input
                    ...
                    className={` ${
                      touched.email && errors.email
                        ? "border-red-500"
                        : touched.email && "border-green-500"
                    } border-black`}
                  ...
                  <PasswordInput
                    ...
                    className={` ${
                      touched.password && errors.password
                        ? "border-red-500"
                        : touched.password && "border-green-500"
                    } border-black`}
                  ...
                  <PasswordInput
                    ...
                    className={` ${
                      touched.confirmpassword && errors.confirmpassword
                        ? "border-red-500"
                        : touched.confirmpassword && "border-green-500"
                    } border-black `}
            ...
            -0
            <p
              onClickCapture={() => setOptional((prev) => !prev)}
              className="text-white cursor-pointer flex items-center gap-2 font-semibold md:text-base text-sm md:my-2"
            >
              Optional Information{" "}
              {optional ? <FaChevronUp /> : <FaChevronDown size={10} />}
            </p>
            <AnimatePresence>
              {optional && (
                <motion.div
                  variants={optionalVariant}
                  animate={optional ? "animate" : "initial"}
                  exit="exit"
